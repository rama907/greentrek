...
// Ganti sebelum di-flash. Harus sama dengan DEVICE_API_KEY di config.php pada server. Jangan di-commit.
const char* DEVICE_API_KEY = "GANTI_DENGAN_KUNCI_PERANGKAT";
...
bool sendHttpPost(String latitude, String longitude, String speed, float loadvoltage, float busvoltage, float shuntvoltage) {
  ...
  sendATcommand("AT+HTTPPARA=\"URL\",\"http://YOUR_SERVER/gpsdata.php\"", "OK", 3000);
